...
module.exports = function serverError (data, options) {
	...
	let userEmail = req.session.userEmail ? req.session.userEmail : 'server@error.com';
	// TODO: Admin Dashboard URL
	...
	if (data instanceof Error) {
		AmplitudeService.trackEvent('Server Error', userEmail, {
			errorMessage: data.message,
			errorStack: data.stack ? data.stack.substring(0, 200) : false
		});
